package com.hqf.common.persistence;
...
public class Page<T> extends RowBounds {
    ...
    public String toString() {
        ...
        sb.append("<input type=\"text\" size=\"1\" value=\"" + this.page + "\"");
        ...
        int begin = this.page - (this.length / 2);
        ...
        for (int i = begin; i <= end; i++) {
            if (i == this.page) {
                sb.append("<li class=\"active\"><a href=\"javascript:\">" + this.page + "</a></li>\n");
            } else {
